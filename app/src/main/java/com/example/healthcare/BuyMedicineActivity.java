...
public class BuyMedicineActivity extends AppCompatActivity {
    private String[][] packages =
            {
                    ...
                    {"Inlife Vitami E Whaet Germ Oil Capsule", "", "", "", "539"},
                    {"Dolo 650 Tablet", "", "", "", "30"},
    ...
    private String[] package_details = {
            ...
            "It promotes health as well as skin benefit\n" +
                    ...
                    "It acts as a safeguard to the skin from the harsh UVA and UVB sun rays.",
            "Dolo 650 tablet helps relieve pain and fever by blocking the release of certain chemical",
            "Helps to relieve fever and bring down the temperature.\n" +
